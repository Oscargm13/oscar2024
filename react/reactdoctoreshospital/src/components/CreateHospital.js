...
export default class CreateHospital extends Component {
    ...
    insertHospital = (e) => {
        ...
        let telefono = parseInt(this.cajaTelefono.current.value);
        let camas = parseInt(this.cajaCamas.current.value);
        //NECESITAMOS UN OBEJTO REACT CON EL MISMO NOMBRE DE PROPIEDADES QUE EL SERVICIO
        let hospital = {
            idhospital: id,
            nombre: nombre,
            direccion: direccion,
    ...
    return (
      <div>
        ...
        <form>
            ...
            <button onClick={this.insertHospital} className='btn btn-primary'>Crear hospital</button>
        </form>
      </div>
    )
  }
